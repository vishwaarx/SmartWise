...
import 'package:iot_ui_challenge/pages/home/widgets/ac.dart';
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
              ...
              colors: <Color>[Color.fromARGB(255, 252, 226, 225), Colors.white]),
        ),
        child: Padding(
                                ...
                                itemBuilder: (BuildContext ctx, index) {
                                  ...
                                  return GestureDetector(
                                    ...
                                    onTap: () {
                                      ...
                                      String color=devices[index].color;
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>MyWidget(value:'$title',color:'$color')));
                                    },
                                    child: Devices(
